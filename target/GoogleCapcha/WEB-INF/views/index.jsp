...
<body>
	<form id='demo-form' action="/user/postform" method="POST" novalidate="novalidate">
		<div class="form-group">
			<label class="sr-only" for="register-firstname">First name</label> <input
				type="text" name="registerfirstname" placeholder="First name"
		...
		<div class="form-group">
			<label class="sr-only" for="register-lastname">Last name</label> <input
				type="text" name="registerlastname" placeholder="Last name"
				class="form-control" id="register-lastname" required="required">
		</div>
		<div class="form-group">
			<label class="sr-only" for="register-email">Email</label> <input
				type="email" name="registeremail" placeholder="Email"
				class="form-control" id="register-email" required="required">
		</div>
		<div class="form-group">
		...
		<div class="g-recaptcha" data-sitekey="6LcZcGIUAAAAAGMDQNCGt-AvCogKURsLHjqtvCH7"></div>
